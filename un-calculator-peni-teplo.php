...
<link rel="stylesheet" href="<?php echo plugins_url( 'un-calculator-peni-teplo-styles.css' , __FILE__ );?>"> 
    <div class="calculator">
        <div class="noprint">
            ...
            <label for="keyRate" style="display: inline;">Ключевая ставка (%): </label>			
            ...
            <div>
		         ...
		         <div style="margin-bottom: 10px;text-align: left;"><a href="https://kodabra.unchikov.ru/wp-content/uploads/2025/02/un-calculator-peni-dolgi.xlsx"><i class="fa-solid fa-download"></i> Скачать шаблон файла для заполнения</a></div>
